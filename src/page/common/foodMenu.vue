<template>
    <div class="body">
        <div class="module">
            <img src="../../assets/imgs/dianzan.jpg" style="width: 50px;height: 50px;"><br>
            <span style="font-size: 20px;color: rosybrown;text-align: center;line-height: 50px;">
                    人气美食
                </span>
            <hr style="width: 1260px;border-top: dotted;color: rosybrown">
            <ul class="module-ul">
                <li class="module-li">
        ...
        <div class="module2">
            <img src="../../assets/imgs/hongbei.jpg" style="width: 50px;height: 50px;"><br>
            <span style="font-size: 20px;color: rosybrown;text-align: center;line-height: 50px;">
                    甜品/烘焙大全
                </span>
            <hr style="width: 1260px;border-top: dotted;color: rosybrown">
        ...
        <div class="module3">
            <img src="../../assets/imgs/jiachang.jpg" style="width: 50px;height: 50px;"><br>
            <span style="font-size: 20px;color: rosybrown;text-align: center;line-height: 50px;">
                    家常菜谱
                </span>
            <hr style="width: 1260px;border-top: dotted;color: rosybrown">
